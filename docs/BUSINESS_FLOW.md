...
- Notification được route theo **việc cần hành động**, không theo quyền xem rộng. Dispatcher nhận **Cần phân công kỹ thuật viên**, **Phiếu đang chờ phụ tùng** và **Phiếu cần xử lý lại**. Customer Service nhận **Cần theo dõi khách sau sửa chữa** mà không nhận quyền Khách xác nhận/Đóng phiếu. Technician nhận **Bạn có công việc mới**, **Lịch của bạn đã thay đổi**, chuyển giao, mở lại, hủy hoặc đóng phiếu khi sự kiện do người khác thực hiện. Warehouse nhận cảnh báo tồn kho; Owner chỉ nhận ngoại lệ quản trị như mở lại/hủy, tồn kho thấp và chênh lệch kiểm kê.
