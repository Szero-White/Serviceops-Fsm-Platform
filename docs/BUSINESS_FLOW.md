...
- `CONSUME` được giữ để tương thích dữ liệu/endpoint legacy trong giai đoạn migration; UI mới không tạo CONSUME. Không rewrite destructive lịch sử cũ.
