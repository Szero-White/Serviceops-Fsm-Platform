...
export const assetsApi = {
  list: (search = '', page = 0, size = 20, customerId?: string, sortBy = 'createdAt', sortDir = 'desc') =>
    http.get<PageResponse<Asset>>('/assets', { params: { search, page, size, customerId, sortBy, sortDir } }).then((response) => response.data),
